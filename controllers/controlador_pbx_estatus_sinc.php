...
use gamboamartin\pbx\models\pbx_estatus_sinc;
use gamboamartin\system\links_menu;
use gamboamartin\template\html;
use html\pbx_campaign_html;
use html\pbx_campaign_sinc_html;
use html\pbx_estatus_sinc_html;
use PDO;
use stdClass;

class controlador_pbx_estatus_sinc extends _pbx_base {

    public string $link_sincroniza_datos = '';

    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass()){
        $modelo = new pbx_estatus_sinc(link: $link);
        $html_ = new pbx_estatus_sinc_html(html: $html);
