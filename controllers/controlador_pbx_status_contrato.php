...
use gamboamartin\pbx\models\pbx_status_contrato;
use gamboamartin\pbx\models\pbx_ultimo;
use gamboamartin\system\links_menu;
use gamboamartin\template\html;
use html\pbx_morosidad_html;
use html\pbx_status_contrato_html;
use html\pbx_ultimo_html;
use PDO;
use stdClass;

class controlador_pbx_status_contrato extends _pbx_base {

    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass()){
        $modelo = new pbx_status_contrato(link: $link);
        $html_ = new pbx_status_contrato_html(html: $html);
