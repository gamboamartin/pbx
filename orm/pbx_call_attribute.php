...
class pbx_call_attribute extends _modelo_parent {
    ...
    public function alta_bd(array $keys_integra_ds = array('codigo', 'descripcion')): array|\stdClass
    {
        ...
        $pbx_call_id = 0;
        if(isset($this->registro['pbx_call_id'])){
            $pbx_call_id = $this->registro['pbx_call_id'];
            unset($this->registro['pbx_call_id']);
        }
        ...
        foreach ($imp_destinos as $imp_destino) {
            ...
            $modelo = new call_attribute($link_destino);
        ...
        if(!isset($this->registro['descripcion'])){
            $descripcion = $this->registro['id_call']." - ";
            $descripcion .= $this->registro['columna']. " - ".  rand(1000000,99999999);
        ...
        $this->registro['pbx_call_id'] = $pbx_call_id;
